          ...
          addedPhotos.map((link) => (
            <div key={link} className="relative w-30 h-40">
              ...
              <button
                ...
                className=" absolute  bottom-0 right-0 cursor-pointer bg-gray-100 p rounded-2xl opacity-60  px-1 py-2"
              >
                <svg
              ...
              <button
                ...
                className=" absolute top-0 left-0  cursor-pointer bg-gray-100 p rounded-2xl opacity-60 px-1 py-2"
              >
                {link === addedPhotos[0] ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
